<html>
<head>
<title>DF Quest Mapper - v0.1</title>
<center>
    <header>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <img onclick="setCell(this)" src="assets/downleftdiagnol.png"></img>
                    <img onclick="setCell(this)" src="assets/downrightdiagnol.png"></img>
                </tr>
            </tbody>
            <tbody>
                <p>Miscellaneous</p>
...
<script>
    ...
    setCell = function(e){
        ...
        //if cell was already configured, don't rebuild map
        if(table.rows[nav_y].cells[nav_x].innerHTML.indexOf("assets/add.png") == -1)
            rebuildable = false;
        ...
        if(hasKeys(["end", "pad.png", "chest.png"], e.src))
            rebuildable = false;
...
<footer>
    <center>
        ...
        Right-click: Set cell as previously selected route
        </p>
    </center>
</footer>
</html>
